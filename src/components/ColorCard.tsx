      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            duration: 0.3,
            delay: delay * 0.05
          }} className={cn('relative group h-16 sm:h-20 md:h-24 rounded-lg overflow-hidden transition-all duration-300 w-full', 'hover:scale-105 hover:shadow-lg focus-within:scale-105 focus-within:shadow-lg')} style={{
